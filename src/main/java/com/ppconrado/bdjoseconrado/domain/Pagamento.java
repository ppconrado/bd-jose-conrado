...
public abstract class Pagamento implements Serializable { //Abstract nao deixa instanciar objetos do tipo Pagamento
	...
	// Id do Pagamento eh o mesmo que o do Pedido
	// Nao tem anotacao de auto-generate
	@Id
	private Integer id;
